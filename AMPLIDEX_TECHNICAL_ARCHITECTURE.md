...
> Production target architecture, security model, and delivery plan

| Field | Value |
|---|---|
| Document owner | AmpliDex Engineering |
| Status | Target architecture for production delivery |
| Version | 1.0 |
| Last updated | 9 August 2026 |
| Settlement network | Stellar / Soroban |
| Primary accounting asset | Native USDC on Stellar |
| Intended audience | Engineers, security reviewers, grant assessors, and technical investors |

> [!IMPORTANT]
> This document defines the intended production system. It is not, by itself, evidence that every component is deployed, audited, or operating on mainnet. The status register distinguishes validated MVP capabilities from production work and later research. Contract addresses, audit reports, operating metrics, and deployment evidence should be added to the evidence register before external due diligence.
...
“MVP validated” reflects the supplied project description. Before publication, link each claim to a repository tag, deployment, test report, or transaction record in [Appendix A](#appendix-a-evidence-register).
